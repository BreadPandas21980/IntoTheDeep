 ...
 */
@Config
public class ColorSubsystemRed extends SubsystemBase {
    ...
    public ColorSubsystemRed(ColorSensor colorSensor, RevBlinkinLedDriver lights ) {
    ...
    public int getColor() {
        if(pooping) {
            ...
            if(stupidstpid == 2 || stupidstpid == 1) {
                grrr = true;
            } else {
                grrr = false;
            }
