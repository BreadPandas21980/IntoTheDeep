...
public class ExampleBucketAuto extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(37, 121, Math.toRadians(180));

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(43, 130, Math.toRadians(180));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(49, 135, Math.toRadians(180));
    ...
    private final Pose parkControlPose = new Pose(60, 98, Math.toRadians(270));
