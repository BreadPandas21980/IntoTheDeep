...
public class FiveSpec extends OpMode {
    ...
    private final Pose scorePose2 = new Pose(70, 110, Math.toRadians(90));
    private final Pose grabPrepPose3 = new Pose(24, 115, Math.toRadians(90));
    private final Pose grabPose3 = new Pose(24, 120, Math.toRadians(90));
    private final Pose scorePose3 = new Pose(70, 110, Math.toRadians(90));
    private final Pose grabPrepPose4 = new Pose(24, 115, Math.toRadians(90));
    private final Pose grabPose4 = new Pose(24, 120, Math.toRadians(90));
    private final Pose scorePose4 = new Pose(70, 110, Math.toRadians(90));
    private final Pose grabPrepPose5 = new Pose(24, 115, Math.toRadians(90));
    private final Pose grabPose5 = new Pose(24, 120, Math.toRadians(90));
    private final Pose scorePose5 = new Pose(70, 110, Math.toRadians(90));
