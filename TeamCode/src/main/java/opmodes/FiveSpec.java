...
public class FiveSpec extends OpMode {
    ...
    private final Pose scorePose = new Pose(20, 67, Math.toRadians(0));
    private final Pose scoreControlPose = new Pose(9, 63, Math.toRadians(0));

    /** Lowest (First) Sample from the Spike Mark */
    private final Pose pickup1Pose = new Pose(11.5, 50, Math.toRadians(0));
    private final Pose scorePose2 = new Pose(30, 30, Math.toRadians(0));

    /** Middle (Second) Sample from the Spike Mark */
    private final Pose pickup2Pose = new Pose(12, 128, Math.toRadians(0));
    private final Pose scorePose3 = new Pose(8.5, 127, Math.toRadians(0));

    /** Highest (Third) Sample from the Spike Mark */
    private final Pose pickup3Pose = new Pose(18.5, 125, Math.toRadians(0));
    private final Pose scorePose4 = new Pose(7, 130.5, Math.toRadians(0));

    /** Park Pose for our robot, after we do all of the scoring. */
    private final Pose parkPose = new Pose(50, 80, Math.toRadians(0));

    /** Park Control Pose for our robot, this is used to manipulate the bezier curve that we will create for the parking.
     * The Robot will not go to this pose, it is used a control point for our bezier curve. */
    private final Pose parkControlPose = new Pose(70, 150, Math.toRadians(0));
        ...
        switch (pathState) {
            ...
            case 1:
                ...
                */
                ...
                if(!follower.isBusy()){// || pathTimer.getElapsedTimeSeconds() > 2){// && timer2.seconds() > 2.5) {
            ...
            case 7:
                ...
                /* This case checks the robot's position and will wait until the robot position is close (1 inch away) from the scorePose's position */
                if(!follower.isBusy() && timer.seconds() > 1.85) {
